...
description: This skill answers questions about Ibis documentation including portable SQL expressions, backends (DuckDB, BigQuery, Postgres), and deferred execution. Use when user asks about Ibis expressions, SQL portability, or connecting to databases. Triggers: ibis, sql, duckdb, bigquery, postgres, portable, expression.
---

# Ibis Documentation Navigator

Direct access to Ibis documentation covering portable dataframe expressions across 20+ SQL backends.
...
**User:** "how do backends work?"

1. Grep `data/` for "backend"
2. Find entry like `ibis:backends/index.md`
3. Read from `.source/ibis/docs/backends/index.md`
