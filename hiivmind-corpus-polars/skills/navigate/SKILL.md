...
description: This skill answers questions about Polars documentation including DataFrames, lazy evaluation, expressions, Series, and Arrow integration. Use when user asks about Polars DataFrame operations, lazy queries, expressions, or Rust/Python data processing. Triggers: polars, dataframe, lazy, expression, rust dataframe, arrow, series.
---

# Polars Documentation Navigator

Direct access to Polars documentation covering DataFrames, expressions, lazy evaluation, I/O, and Rust/Python bindings.
...
- **Synonyms**: Related terms (e.g., "filter" → also try "select", "where")
- **Domain terms**: Polars concepts (e.g., "lazy" → also try "LazyFrame", "collect")
...
**Index entry found:** `polars:concepts/lazy-api.md`

**Step 1 - Parse the path:**
- `source_id` = `polars` (everything before the colon)
- `relative_path` = `concepts/lazy-api.md` (everything after the colon)
...
- Local clone: `.source/polars/docs/source/concepts/lazy-api.md`
- GitHub URL: `https://raw.githubusercontent.com/pola-rs/polars/main/docs/source/concepts/lazy-api.md`
