---
name: polars-navigate
description: Find relevant Polars documentation. Use when working with Polars DataFrames, expressions, lazy API, data transformations, or Python/Rust data processing.
---
